...
public class DaoUsuario {
	...
	public void salvar(BeanCursoJsp usuario) {
		...
		try {
			...
			String sql = "insert into usuario(login, senha, nome, telefone, cep, rua, bairro, cidade, estado, ibge, fotobase64, contenttype, contenttypecurriculo, curriculobase64, fotoBase64Miniatura, ativo, sexo, perfil) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	public BeanCursoJsp consultar(String id) throws Exception {
		...
		if (resultSet.next()) {
			BeanCursoJsp beanCursoJsp = new BeanCursoJsp(); // cria��o do objeto
			beanCursoJsp.setId(resultSet.getLong("id"));
			beanCursoJsp.setLogin(resultSet.getString("login"));
			beanCursoJsp.setSenha(resultSet.getString("senha"));
			beanCursoJsp.setNome(resultSet.getString("nome"));
			...
			return beanCursoJsp; // como � um s� objeto, ele ser� especificado e n�o uma lista
		}
		return null;
	}
