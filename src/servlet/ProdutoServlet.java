...
public class ProdutoServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -5956600755618477786L;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (acao != null && acao.equalsIgnoreCase("reset")) {
			...
			try {
				...
				if (nome == null || nome.isEmpty()) {// valida��o de nome de produto inv�lido ou vazio
					msg = "Nome do produto deve ser informado";
					podeInserir = false;

				} else if (quantidade == null || quantidade.isEmpty()) {// valida��o de quantidade inv�lida ou vazia
					msg = "Quantidade deve ser informada";
					podeInserir = false;

				} else if (valor == null || valor.isEmpty()) {// valida��o de valor inv�lido ou vazio
					msg = "Valor deve ser informado";
					podeInserir = false;
				}else if (id == null || id.isEmpty() && !daoProduto.validarNome(nome)) { // QUANDO FOR NOVO PRODUTO
